...
function findElementGreaterThan(arr, num) {
  ...
  // Перевіряємо чи є елемент, який задовольняє умову
  // Якщо так, повертаємо елемент, в іншому випадку повертаємо рядок "Число, яке задовольняє умову, не знайдено"
...
function findLongestWord(arr) {
  ...
  const longestWord = arr.reduce((longest, current) => {
    ...
    if (current.length > longest.length) {
      // Якщо поточне слово довше, замінюємо найдовше слово на поточне
      return current;
    } else {
      // Інакше повертаємо попереднє найдовше слово без змін
      return longest;
